...
describe('tests the Wallet component', () => {
  ...
  // it('checks if the total changes when adding a new expense', () => {
  //   renderWithRouterAndRedux(<App />);
  //   const email = screen.getByRole('textbox');
  //   const password = screen.getByTestId(pwInput);
  //   const button = screen.getByRole('button', { name: /entrar/i });
  ...
  //   const addExpButton = screen.getByRole('button', { name: /adicionar despesa/i });
  //   const valueInput = screen.getAllByTestId('value-input');
  //   userEvent.type(valueInput, '1');
  //   userEvent.click(addExpButton);

  //   const total = screen.getByTestId('total-field');

  //   expect(total.innerHTML).toBe('5.30');
  // });

  // it('checks if clicking the Add Expense button adds a new row', async () => {
  //   renderWithRouterAndRedux(<App />);
  //   const email = screen.getByRole('textbox');
  //   const password = screen.getByTestId(pwInput);
  //   const button = screen.getByRole('button', { name: /entrar/i });
  ...
  //   act(() => userEvent.click(addExpButton));

  //   waitFor(() => {
  //     const tr0 = screen.getByTestId('tr0');
  //     expect(tr0).toBeInTheDocument();
  //   });
  // });
